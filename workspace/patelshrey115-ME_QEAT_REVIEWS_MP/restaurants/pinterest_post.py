...
# write your code below
    ...
    def publish_photo_msg(self, message, image_url):
        ...
        image_url = 'https://api.pinterest.com/v1/pins/?' + self.board_id + '/photos?access_token=' + self.access_token
        response = requests.post(url=image_url, params=params, data=data)
